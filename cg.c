...
static int __init zero_page_refcount_fix_init(void)
{
	test_it();
	return 0;
}

static void __exit zero_page_refcount_fix_exit(void)
{
}

module_init(zero_page_refcount_fix_init);
module_exit(zero_page_refcount_fix_exit);
MODULE_LICENSE("GPL");
